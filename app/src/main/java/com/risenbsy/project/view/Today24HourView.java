...
import com.risenbsy.project.util.DisplayUtil;
import com.risenbsy.project.viewdemo.HourItem;
...
public class Today24HourView extends View{
   ...
   // private int textSize = 12;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        lineColor = a.getColor(R.styleable.Today24HourView_mLineColor,Color.parseColor("#fee55b"));
...
//                DisplayUtil.dip2px(context, textSize));
        dotSize = (int) a.getDimension(R.styleable.Today24HourView_dotSize,
                DisplayUtil.dip2px(context, dotSize));
        unitText = a.getString(R.styleable.Today24HourView_mUnitText);
        a.recycle();
